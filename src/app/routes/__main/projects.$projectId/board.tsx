...
export const action: ActionFunction = async ({ request }) => {
  ...
  if(_action === "createIssueusingAI"){
    console.log("Creating issue using AI");
    const query= formData.get("query") as string;
    await createIssueusingAI(query);
    return json({msg:"dk you"}, { status: 201 });
  }
