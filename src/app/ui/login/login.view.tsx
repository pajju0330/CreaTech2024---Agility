...
export const LoginView = ({ users }: Props) => {
  ...
  return (
    <div className="mx-auto max-w-[400px] pt-[10vh]">
      <h1 className="font-primary-black text-5xl text-font" style={{textAlign:'center'}}>
        Login to your account
      </h1>
      <h2 className="mb-8 mt-3 font-primary-light text-lg text-font-subtle" style={{textAlign:'center'}}>
       Welcome to Agility  <br/>New Generation Project Management Platofrm
      </h2>
